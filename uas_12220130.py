...
#fitur tambahan navbar
with navbar:
    st.sidebar.markdown("# Menu navigasi")
    st.sidebar.markdown("#### Pergi ke:")
    st.sidebar.markdown("[Graph produksi tiap negara](#produksi-per-negara)")
    st.sidebar.markdown("[Graph produsen terbesar tahunan](#produksi-minyak-terbesar-tahunan)")
    st.sidebar.markdown("[Graph produsen minyak terbesar](#produsen-minyak-terbesar)")
    st.sidebar.markdown("[Filter dan info negara](#filter-dan-info-negara)")

with judul:
    st.title("Data produksi minyak")
